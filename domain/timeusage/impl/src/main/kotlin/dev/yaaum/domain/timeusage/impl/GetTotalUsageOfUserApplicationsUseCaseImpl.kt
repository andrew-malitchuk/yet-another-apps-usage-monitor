...
class GetTotalUsageOfUserApplicationsUseCaseImpl(
    private val timeUsageRepository: TimeUsageRepository,
    private val applicationsRepository: ApplicationsRepository,
) : GetTotalUsageOfUserApplicationsUseCase {
    ...
    override suspend fun invoke(
        ...
        return try {
            val usersApplications = applicationsRepository.getUserApplications()
