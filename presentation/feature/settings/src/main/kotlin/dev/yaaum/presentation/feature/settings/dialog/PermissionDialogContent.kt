package dev.yaaum.presentation.feature.settings.dialog
...
fun PermissionDialogContent(
    ...
    Column(
        ...
        Text(
            text = UiText
                .StringResource(R.string.settings_permission_dialog_title)
        ...
        Text(
            text = UiText
                .StringResource(R.string.settings_permission_dialog_description)
                .asString(LocalContext.current),
...
@Composable
fun Preview_PermissionDialogContent_Dark() {
...
@Preview(showBackground = true)
@Composable
fun Preview_PermissionDialogContent_Light() {
