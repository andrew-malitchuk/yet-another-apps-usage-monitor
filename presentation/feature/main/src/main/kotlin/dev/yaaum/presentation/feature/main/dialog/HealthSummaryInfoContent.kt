...
fun HealthSummaryInfoContent(
    ...
    Column(
        ...
        Text(
            text = UiText
                .StringResource(R.string.main_health_summary_dialog_title)
        ...
        Text(
            text = UiText
                .StringResource(R.string.main_health_summary_dialog_description)
                .asString(LocalContext.current),
...
@Composable
fun Preview_HealthSummaryInfoContent_Dark() {
...
@Preview(showBackground = true)
@Composable
fun Preview_HealthSummaryInfoContent_Light() {
