...
fun TopAppsInfoContent(
    ...
    Column(
        ...
        Text(
            text = UiText
                .StringResource(R.string.main_top_apps_dialog_title)
        ...
        Text(
            text = UiText
                .StringResource(R.string.main_top_apps_dialog_description)
                .asString(LocalContext.current),
...
@Composable
fun Preview_TopAppsInfoContent_Dark() {
...
@Preview(showBackground = true)
@Composable
fun Preview_TopAppsInfoContent_Light() {
