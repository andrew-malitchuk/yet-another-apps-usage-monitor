package dev.yaaum.presentaion.feature.onboarding.dialog
...
fun OnboardingDialogContent(
    ...
    Column(
        ...
        Text(
            text = UiText
                .StringResource(R.string.onboarding_dialog_title)
        ...
        Text(
            text = UiText
                .StringResource(R.string.onboarding_dialog_description)
                .asString(LocalContext.current),
...
@Composable
fun Preview_OnboardingDialogContent_Dark() {
...
@Preview(showBackground = true)
@Composable
fun Preview_OnboardingDialogContent_Light() {
